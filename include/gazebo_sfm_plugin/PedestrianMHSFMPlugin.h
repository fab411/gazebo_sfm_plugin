...
#ifndef GAZEBO_PLUGINS_PedestrianMHSFMPlugin_HH_
#define GAZEBO_PLUGINS_PedestrianMHSFMPlugin_HH_
...
// Social Force Model
#include <gazebo_sfm_plugin/mhsfm.hpp>

namespace gazebo {
class GZ_PLUGIN_VISIBLE PedestrianMHSFMPlugin : public ModelPlugin {
  /// \brief Constructor
public:
  PedestrianMHSFMPlugin();
