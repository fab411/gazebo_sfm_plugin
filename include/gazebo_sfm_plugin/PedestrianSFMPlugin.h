...
//#include "gazebo_sfm_plugin/msg/vector3.hpp"
//#include "gazebo_sfm_plugin/msg/point.hpp"
// #include "gazebo_sfm_plugin/msg/uuid.hpp"
...
// private:
  // Deklaration der ROS 2-Publisher
  // rclcpp::Publisher<geometry_msgs::msg::Pose>::SharedPtr positionPublisher;
  // rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr velocityPublisher;

  // Deklaration der Nachrichten
  // geometry_msgs::msg::Pose positionMsg;
  // geometry_msgs::msg::Twist velocityMsg;

  // Restliche Klassenmember und Funktionen
  // ...
...
private:
 ...
 /// \brief Helper function to publish the computed obstacle using the SFM
private:
...
private:
  ...
  /// \brief Boolean to decide wether to publish Obstacle or not
private:
  bool publishObstacle;
...
private:
  std::string obstacle_nodeName;

  /// \brief Stores the node used to publish forces
private:
  rclcpp::Node::SharedPtr forcesNode;

/// \brief Stores the node used to publish obstacle
private:
  rclcpp::Node::SharedPtr obstacleNode;

  /// \brief Stores the forces publisher
private:
  rclcpp::Publisher<gazebo_sfm_plugin::msg::Forces>::SharedPtr forcesPub;

  /// \brief Stores the Obstacle publisher
private:
  rclcpp::Publisher<gazebo_sfm_plugin::msg::Obstacle>::SharedPtr obstaclePub;
