...
#ifndef GAZEBO_PLUGINS_PEDESTRIANSFM2PLUGIN_HH_
#define GAZEBO_PLUGINS_PEDESTRIANSFM2PLUGIN_HH_
...
// Social Force Model
#include <gazebo_sfm_plugin/sfm2.hpp>

namespace gazebo {
class GZ_PLUGIN_VISIBLE PedestrianSFM2Plugin : public ModelPlugin {
  /// \brief Constructor
public:
  PedestrianSFM2Plugin();
...
private:
  std::vector<sfm2::Agent> otherActors;
